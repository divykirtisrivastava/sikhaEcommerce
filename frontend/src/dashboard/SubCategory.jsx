...
console.log(data)
  ...
  return (
    ...
    <div className='absolute flex flex-col items-center w-[80%] left-[20%] top-20'>
      <Link to='/admin/newsubcategory' className='p-3 rounded-lg bg-sky-700 m-5 text-white font-bold hover:bg-black'>Add Category Image</Link>
            ...
            <table className="min-w-full divide-y divide-gray-200 bg-white">
              <thead>
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Category Image Action </th>
