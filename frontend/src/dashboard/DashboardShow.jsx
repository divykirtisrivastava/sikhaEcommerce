...
export default function DashboardShow({ title, value, onViewMore }) {
  ...
  async function getProfile() {
    try {
      ...
      let responce = await axios.get('https://actl.co.in/sikha/categoryget');
      let res = await axios.get('https://actl.co.in/sikha/subcategoryget');
      let order = await axios.get('https://actl.co.in/sikha/getOrder');
